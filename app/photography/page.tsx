...
import { photographyHero, photographyStory, photos } from "./content";
    ...
    <section className="relative overflow-hidden py-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-10 md:pt-14">
          ...
          <div className="mt-10 grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
                {photographyHero.eyebrow}
              </p>
              <h1 className="mt-3 text-4xl font-bold">{photographyHero.title}</h1>
              <p className="mt-4 max-w-2xl text-lg text-neutral1">
                {photographyHero.description}
              </p>
            </div>
        ...
        <div className="mt-10 rounded-2xl bg-white shadow-sm p-6 md:p-10">
          <h2 className="text-2xl font-bold mb-4">{photographyStory.heading}</h2>
          <p className="text-neutral1 leading-relaxed">{photographyStory.body}</p>
        </div>
      </div>
      <style jsx>{`
        .photography-marquee {
